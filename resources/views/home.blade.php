    ...
    <script>
        class InstagramDownloader {
                ...
                displayPosts(posts) {
                    ...
                    if (posts.length === 0) {
                        this.postsGrid.innerHTML = '<p style="text-align: center; color: #666; grid-column: 1/-1;">No posts available</p>';
                        return;
                    }
            ...
            <div class="post-image-container">
                <img src="${proxyImageUrl}" alt="Post" class="post-image" loading="lazy" 
